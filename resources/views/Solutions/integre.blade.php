            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-6 col-12">
                    <div class="hero-content-wrap text-white">
                        <p style="color: #005cbf"><b>ITHRYTEC PARTENAIRE ODOO</b></p>
            ...
            <div class="row justify-content-center">
                <div class="col-md-9 col-lg-8">
                    <div class="section-heading text-center mb-5">
                        <p style="color: #005cbf"><b>ITHRYTEC PARTENAIRE ODOO</b></p>
                        <h3 class="text-white">ITHRYTEC, Intégrateur Odoo en Algérie </h3>
                        <p class="text-white">ITHRYTEC est spécialisée dans l'intégration et le déploiement de l'ERP Odoo ainsi que les technologies qui y
                            sont liées. L'équipe ITHRYTEC vous assure un accompagnement durant tout le processus afin de garantir
                            une implémentation efficace.<b> Nous intégrons, développons et configurons votre solution Open Soure
                            ITHRYTEC</b> met à votre disposition son savoir-faire afin de réaliser et réussir vos projets.</p>
