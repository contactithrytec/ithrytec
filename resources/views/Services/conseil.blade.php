                ...
                <div class="col-md-6 col-lg-6">
                    <div class="single-service-plane text-center rounded white-bg shadow-sm p-5 mt-md-4 mt-lg-4">
                        ...
                        <div class="service-plane-content">
                            ...
                            <p>ITHRYTEC aide les organisations de différentes échelles et structures à sélectionner et à
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="single-service-plane text-center rounded white-bg shadow-sm p-5 mt-md-4 mt-lg-4">
                        ...
                        <div class="service-plane-content">
                            ...
                            <p>ITHRYTEC vous apporte ses conseils et son expertise en transformation digitale et vous
