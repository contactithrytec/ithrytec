                ...
                <div class="col-md-10 col-lg-10">
                    <div class="single-service-plane text-center rounded white-bg shadow-sm p-5 mt-md-4 mt-lg-4">
                        ...
                        <div class="service-plane-content">
                            ...
                            <p>ITHRYTEC propose des services de développement web full-stack incluant tous types d'applications
                ...
                <div class="col-md-10 col-lg-10">
                    <div class="single-service-plane text-center rounded white-bg shadow-sm p-5 mt-md-4 mt-lg-4">
                        ...
                        <div class="service-plane-content">
                            ...
                            <p>Obtenez des solutions sur mesure livrées rapidement et à moindre coût avec ITHRYTEC. Nous développons
                ...
                <div class="col-md-10 col-lg-10">
                    <div class="single-service-plane text-center rounded white-bg shadow-sm p-5 mt-md-4 mt-lg-4">
                        ...
                        <div class="service-plane-content">
                            ...
                            <p>ITHRYTEC vous aide à intégrer une solution ERP qui partage les données transactionnelles provenant de
                ...
                <div class="col-md-10 col-lg-10">
                    <div class="single-service-plane text-center rounded white-bg shadow-sm p-5 mt-md-4 mt-lg-4">
                        ...
                        <div class="service-plane-content">
                            ...
                            <p>
                                L'informatique basée sur le cloud domine le monde numérique aujourd'hui, ITHRYTEC vous aide à intégrer
