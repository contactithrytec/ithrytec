            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-5 col-12">
                    <div class="hero-image mt-5">
                        <img style="border-radius:0px 100px 100px 100px; background-color: white;color:#302e69" src="{{asset('img/ithrytec/ithrytec_logo.png')}}"  alt="security" class="hero-shape-img img-fluid py-5 px-3" />
                    </div>
                </div>
            </div>
        </div>
