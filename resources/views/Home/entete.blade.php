        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-lg-6 col-12">
                <div class="hero-content-wrap text-white">
                    <h1 class="text-white">IT <br> Solutions <br> Agency</h1>
                    <p class="lead">ITHRYTEC aide les organisations de différentes échelles et structures à améliorer et à moderniser leurs stratégies numériques et à mettre en œuvre de nouvelles technologies pour rester compétitives et répondre aux exigences des marchés modernes.</p>
            ...
            <div class="col-lg-6 col-12">
                <div class="animation-image-wrap">
                    <img src="{{asset('img/ithrytec/entete_home.png')}}" alt="wp hosting" class="img-fluid" />
                </div>
            </div>
        </div>
    </div>
